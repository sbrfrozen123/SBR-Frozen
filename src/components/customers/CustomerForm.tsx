        ...
        <form id="customer-form" onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="form-group md:col-span-2">
              ...
              <textarea {...register('address')} rows={3} className="input resize-none" placeholder="Alamat pengiriman..." />
            </div>
            ...
            <div className="form-group">
              ...
              <span className="text-xs text-dark-400 mt-1">Set 0 jika tidak boleh hutang/kasbon.</span>
            </div>
